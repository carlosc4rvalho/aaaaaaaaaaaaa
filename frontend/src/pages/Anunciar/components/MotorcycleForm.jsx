      ...
      <DndProvider backend={HTML5Backend}>
        <section className='m-4 flex flex-col gap-4 rounded-xl border-2 border-gray-300 bg-white p-4 text-black w-11/12 md:w-1/2'>
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-2'>
              <label className='font-medium' htmlFor='mileage'>Quilometragem</label>
              <input
                className='rounded-xl bg-gray-200 p-4'
                type='text'
                name='mileage'
                placeholder='Ex: 15000'
                {...register('mileage', { required: 'Quilometragem é obrigatória' })}
              />
              {errors.mileage && <span className='text-red-500'>{errors.mileage.message}</span>}
            </div>

            <div className='flex flex-col gap-2'>
              <label className='font-medium' htmlFor='displacement'>Cilindrada</label>
              <input
                className='rounded-xl bg-gray-200 p-4'
                type='text'
                name='displacement'
                placeholder='Ex: 500cc'
                {...register('displacement', { required: 'Cilindrada é obrigatória' })}
              />
              {errors.displacement && <span className='text-red-500'>{errors.displacement.message}</span>}
            </div>

            <div className='flex flex-col gap-2'>
              <label className='font-medium' htmlFor='brakes'>Freios</label>
              <input
                className='rounded-xl bg-gray-200 p-4'
                type='text'
                name='brakes'
                placeholder='Ex: ABS'
                {...register('brakes', { required: 'Freios são obrigatórios' })}
              />
              {errors.brakes && <span className='text-red-500'>{errors.brakes.message}</span>}
            </div>

            <div className='flex flex-col gap-2'>
              <label className='font-medium' htmlFor='transmission'>Transmissão</label>
              <input
                className='rounded-xl bg-gray-200 p-4'
                type='text'
                name='transmission'
                placeholder='Ex: Manual'
                {...register('transmission', { required: 'Transmissão é obrigatória' })}
              />
              {errors.transmission && <span className='text-red-500'>{errors.transmission.message}</span>}
            </div>

            <div className='flex flex-col gap-2'>
              <label className='font-medium' htmlFor='fuel'>Combustível</label>
              <input
                className='rounded-xl bg-gray-200 p-4'
                type='text'
                name='fuel'
              ...
              />
              {errors.fuel && <span className='text-red-500'>{errors.fuel.message}</span>}
            </div>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <textarea
                ...
                name='description'
                rows='4'
                placeholder='Descrição detalhada da motocicleta'
